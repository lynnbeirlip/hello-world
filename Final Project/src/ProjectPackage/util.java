...
public class util {
 ...
 public static final String FILE_PATH = "C:\\Users\\lynn.bierl\\Input for final project.xlsx"; // File Path
 public static final String SHEET_NAME = "Sheet1"; // Sheet name
 public static final String TABLE_NAME = "LoginTable"; // Name of data table
 ...
 /* You can change the Path of Chrome base on your environment here */
 public static final String CHROME_PATH = "C:\\Selenium\\chromedriver.exe";
 ...
 public static String[][] getDataFromExcel(String xlFilePath,
			String SHEET_NAME, String TABLE_NAME) throws Exception {
